...
impl Resources {
    pub fn load_resources() -> Self {
        ...
        r.platforms.insert(Difficulty::Medium, Texture2D::from_file_with_format(include_bytes!("../../resources/textures/floor_medium.png"), None));
        r.platforms.insert(Difficulty::Hard, Texture2D::from_file_with_format(include_bytes!("../../resources/textures/floor_hard.png"), None));
